  ...
  return (
    <Layout>
      <div className={`w-full relative ${isDarkEnabled ? "bg-[#010844]" : " "}`} style={{color:colors.text}}>
        <div className={`flex items-center gap-4 h-12 border-b z-10 shadow-sm px-4 sticky top-0 cursor-pointer ${isDarkEnabled ? "border-gray-600" : ""}`} style={{background:colors.thirdCardBg}} onClick={()=>navigate('/')}>
          ...
          <div className={`w-full sm:w-1/4 border rounded-md max-h-60 ${isDarkEnabled ? "border-gray-600" : ""}`}
           style={{background:colors.cardBg}}>
            ...
            <div className="w-full flex flex-col justify-center items-center">
              ...
              <div className="p-1 w-full">
                <div
                  onClick={()=>pageswithc("/profile/add-clinic-info")}
                  className={`w-full h-10 flex justify-center items-center 
                    ${pathname === "/profile/add-clinic-info"
                      ? isDarkEnabled 
                        ? "bg-[#040836]"  // Dark mode background color
                        : "bg-[#006afe]"  // Light mode background color
                      : isDarkEnabled 
                    ...
                    rounded-md cursor-pointer`}
                >
                  <p className="text-xs text-white font-semibold">Add Clinic</p>
                </div>
              </div>
              <div className="p-1 w-full">
                <div
