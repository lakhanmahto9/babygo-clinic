...
const Myinformation = () => {
  ...
  return (
    <Profile>
      ...
      >
        <div
          className={`p-4 border-b ${isDarkEnabled ? "border-gray-600" : ""}`}
        >
          <p className="font-bold">Add Information</p>
        </div>
        <form
          onSubmit={handleSubmit}
          className="p-4 w-full md:w-2/3 flex flex-col gap-4"
        >
          <div className="flex flex-col sm:flex-row w-full gap-4">
            <div className="w-full">
              ...
              <input
                ...
                className={`rounded-md w-full h-12 outline-none px-2 ${
                  isDarkEnabled
          ...
          <div className="w-full">
            <select
              ...
              onChange={handleInputChange}
              className={`w-full rounded-md h-12 my-2 text-slate-400 outline-none ${
                isDarkEnabled
                  ? "border border-gray-600"
                  : "border-2 border-slate-400"
              }`}
          ...
          <button
            type="submit"
            className={`px-10 py-2 border rounded-md my-4 shadow-md  text-white ${
              isDarkEnabled ? "bg-[#040836] border-gray-600" : "bg-[#006afe]"
            }`}
          >
