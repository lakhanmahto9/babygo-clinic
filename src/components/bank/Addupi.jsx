...
const Addupi = () => {
  ...
  return (
    <BankHome>
      <div className={`w-full border rounded-sm p-4 ${isDarkEnabled ? "border-gray-600" : ""}`} style={{background:colors.cardBg,color:colors.text}}>
        <p className="font-semibold mb-4">Manage UPI Details</p>
        {!open ? (
          <div
