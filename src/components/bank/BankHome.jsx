  ...
  return (
    <Layout>
      <div className="w-full relative">
        <div
          onClick={gotohome}
          className={`w-full h-14 sticky top-0  shadow-sm flex justify-start items-center px-4 gap-4 border-b cursor-pointer ${
        ...
        <div className="w-full p-4 flex flex-col md:flex-row gap-4">
          <div
            className={`w-full md:w-1/3 h-auto max-h-72 rounded-md border ${
              isDarkEnabled ? "border-gray-600" : ""
            }`}
